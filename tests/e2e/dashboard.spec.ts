...
test.describe('Dashboard Page', () => {
  test('loads metrics, hero queue, and funnel visualization', async ({ page }) => {
    ...
    // Page header
    await expect(page.locator('text=SALES INTELLIGENCE COMMAND')).toBeVisible();

    // Metrics cards
    await expect(page.locator('text=Total Opps')).toBeVisible();
    ...
    await expect(page.locator('[data-testid="dashboard-page"] >> text=ABC Technologies').first()).toBeVisible();
